...
<body>
    ...
    <main class="justify-content-center about_container">
        ...
        <hr class="d-none d-md-block about_hr">
        ...
        <section class="row Our_vision">
            ...
            <div class="col-sm-12 col-md-6 text-center text_box">
                ...
                <p class="about_paragraph">Our vision is a simple one, we are here for you. We have many years of experience in supplying others with quality merchandise but not any longer. Carefully sourced and often unique products on the market are now at the reach of your fingertips! But do not take our word for it. We have created a blog dedicated to our online store. From daily inspirations, personal favourites, new in, to the latest must-have trend alerts, we have you up to date and up to speed! We encourage community engagement and believe in the power of your voice.</p>

                <p class="about_paragraph">The concept is simple, create an account, read our blog and feel free to comment on all post that capture your attention. Good or bad experience/opinion is always an opportunity for us to do things better, so we welcome all your suggestions! But let’s keep things light and polite, we are all about constant improvement, but also mutual respect</p>
        ...
        <section class="row About_us">
            ...
            <div class="col-sm-12 col-md-6 text-center text_box">
                ...
                <p class="about_paragraph">It took us a long time to get where we are today! From a wholesaler to retailer, the journey was long and we had many lessons to learn along the way. We believe in the value of learning-by-doing, the decision to cater our services, knowledge and expertise directly to You, our customer, was an easy one! An we are here to learn and listen, so make sure you join us, and share your thoughts as we begin this exciting journey.</p>

                <p class="about_paragraph">From shabby chic to Scandinavian minimalism, we want to know what you think! Make sure to check in regularly, get update and comment, as the saying goes "the customer is always right" so we want o to make it right by you! Come on in, the shop is open!</p>
